...
**Triggers**: "template mode", "exact", "copy", "standard", "production-ready", specific component requests (e.g., "give me a RetroCard")
...
**Ambiguous?** If both signals present, ask: "Would you like exact template patterns or creative interpretation of the Retro UI aesthetic?"
