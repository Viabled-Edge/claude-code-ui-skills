...
**Triggers**: "template mode", "exact", "copy", "standard", "production-ready", specific component requests (e.g., "give me a SharpCard")
...
**Ambiguous?** If both signals present, ask: "Would you like exact template patterns or creative interpretation of the Sharp UI aesthetic?"
